...
MODEL_PATH = Path("archive/models/artifacts/stage1_legacy_xgboost_micro_model.json")
ENCODER_PATH = Path("archive/models/artifacts/stage1_legacy_xgboost_micro_encoder.pkl")
